...
- **Exactly one task may be active:** NONE (T-01, T-02, T-03 complete and approved; T-04 or T-10 may activate next)
...
| No agent/tool assigned yet to T-04 or T-10 | Both unblocked (T-01/T-02/T-03 approved) but need an implementer assigned before activating; T-05 remains blocked on T-04 in addition to T-03 | alex.nykolaiszyn@gmail.com | Choose which task to activate next and assign an implementer | 2026-07-27 |
